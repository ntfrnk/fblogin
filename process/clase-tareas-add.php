...
$tareas_prev = listReg("cursos_clases_preguntas", " where claseID='".$pow_post['Id']."'");

$orden = count($tareas_prev);

insertReg("cursos_clases_preguntas", array("claseID","pregunta","orden"), array($pow_post['Id'],$pow_post['consigna'],$orden));
